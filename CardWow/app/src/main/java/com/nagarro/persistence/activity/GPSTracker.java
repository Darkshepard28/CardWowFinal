...
public class GPSTracker extends Service implements LocationListener {
    ...
    /**getLocations throws some permissions errors but this does not effect our program running**/
    ...
    @Override
    /**Makes sure that when our location changes we update the database*/
    public void onLocationChanged(Location location) {
        ...
        for(int i = 0; i<user_List.size();i++){
            if(user_List.get(i).getFirstName()=="Zachary"){
                user_List.get(i).setLat(getLatitude());
                user_List.get(i).setLon(getLongitude());
